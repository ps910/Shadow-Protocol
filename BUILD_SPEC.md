...
| CadetOnboarding   | Interactive 4-step Flight Manual (Cadet Briefing) |
| FeedbackModal     | Community feedback widget with ZK nullifiers |
| PreprodDirectory  | 70 Preprod user explorer & telemetry (Level 6 Supermoon) |
...
npm test             # Run automated tests (47 tests)
npx tsx scripts/verify_preprod_users.ts # Run 70-user Preprod audit
```

## Test Coverage

- 47 tests across multiple test suites
- Tests cover: Aegis Station mechanics, mini-games, sabotages, room alibis, crypto primitives, role validation, 70 preprod users, feedback loop, UI rendering
